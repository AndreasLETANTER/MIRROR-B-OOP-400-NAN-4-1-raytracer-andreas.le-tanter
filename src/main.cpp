...
int main(void)
{
    ...
    RayTracer::Plane plane(Math::Point3D(0., 0.2, 0.), Math::Vector3D(0., -1., 0.), Math::Vector3D(18, 164, 139));
    RayTracer::Plane plane2(Math::Point3D(0.2, 0., 0.), Math::Vector3D(-1., 0., 0.), Math::Vector3D(18, 164, 139));
