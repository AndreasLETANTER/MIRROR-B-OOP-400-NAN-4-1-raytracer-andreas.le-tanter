...
// {
//     Math::Vector4D originCameraSpace = projectionMatrix * Math::Vector4D(t_ray.m_origin, 1.0);
//     Math::Vector4D centerCameraSpace = projectionMatrix * Math::Vector4D(c_center, 1.0);
...
//     double c = pow(OC.m_x_component, 2) + pow(OC.m_z_component, 2) - pow(c_radius, 2);
...
//         return false;
//     }
//     Math::Vector4D hitPointWorldSpace = projectionMatrix.inverse() * Math::Vector4D(hitPointCameraSpace, 1.0);
